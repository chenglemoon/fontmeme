...
export default function BuiltWithButton() {
  return (
    <Link
      href="https://fontmeme.fun"
      title="Built with fontmeme.fun"
      prefetch={false}
      target="_blank"
      rel="noopener noreferrer"
      className={cn(
        buttonVariants({ variant: "outline", size: "sm" }),
        "px-4 rounded-md bg-white border-white hover:bg-white/90 text-black hover:text-black"
      )}
    >
      ...
      <span className="font-bold text-black flex gap-0.5 items-center tracking-tight">
        fontmeme.fun
      </span>
    </Link>
  );
