...
export default function HeroSection() {
  const t = useTranslations("UndertaleFont.hero");
  const tGen = useTranslations("UndertaleFont.generator");
  const canvasRef = useRef<HTMLCanvasElement>(null);
  const [text, setText] = useState("UNDERTALE");
