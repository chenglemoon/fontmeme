...
export const AVAILABLE_FONTS: FontInfo[] = [
  {
    name: "MonsterFriendBack",
    file: "/Undertale Font/MonsterFriendBack.otf",
    displayName: "Monster Friend Back",
  },
  {
    name: "MonsterFriendFore",
    file: "/Undertale Font/MonsterFriendFore.otf",
    displayName: "Monster Friend Fore",
  },
];
