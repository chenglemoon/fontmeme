...
export default function About() {
  const t = useTranslations("CalligraphyGenerator.about");
  const [fontLoaded, setFontLoaded] = useState(false);
  const titleCanvasRef = useRef<HTMLCanvasElement>(null);
  const [selectedFont] = useState("ArizoniaRegular"); // 使用优雅的书法字体
          ...
          <div className="space-y-6">
            <div className="relative">
              ...
              <p 
                ...
                style={fontLoaded ? { fontFamily: `"${selectedFont}", serif`, fontSize: '1.5rem', lineHeight: '2rem' } : {}}
              >
                {t("description1")}
              </p>
            </div>
