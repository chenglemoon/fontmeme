...
export default function HeroSection() {
  const t = useTranslations("MinecraftFont.hero");
  const tGen = useTranslations("MinecraftFont.generator");
  const canvasRef = useRef<HTMLCanvasElement>(null);
  const [text, setText] = useState("Minecraft");
