...
export default function About() {
  const t = useTranslations("TheLifeOfAShowgirlFont.about");
  const [fontLoaded, setFontLoaded] = useState(false);
  const titleCanvasRef = useRef<HTMLCanvasElement>(null);
  const [selectedFont] = useState("SteelfishRgIt"); // 使用 Steelfish Regular Italic 字体（更细）
          ...
          <div className="space-y-6">
            <div className="relative">
              ...
              <p className="text-white text-base md:text-lg leading-relaxed pl-6">
                <em className="text-yellow-400">The Life of a Showgirl</em> {t("description1")}
              </p>
            </div>
