...
export default function HeroSection() {
  const t = useTranslations("DisneyFont.hero");
  const tGen = useTranslations("DisneyFont.generator");
  ...
  const [color, setColor] = useState("#10b981"); // Disney green/emerald
