...
export default function HeroSection() {
  const t = useTranslations("TamilFontGenerator.hero");
  const tGen = useTranslations("TamilFontGenerator.generator");
  const canvasRef = useRef<HTMLCanvasElement>(null);
  const [text, setText] = useState("தமிழ்");
