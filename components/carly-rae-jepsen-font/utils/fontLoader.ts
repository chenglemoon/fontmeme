...
export const AVAILABLE_FONTS: FontInfo[] = [
  {
    name: "ColorsOfAutumn",
    file: "/Colors-Of-Autumn/Colors-Of-Autumn-1.ttf",
    displayName: "Colors Of Autumn",
  },
  {
    name: "OPTIAlternateThree",
    file: "/OPTIAlternateThree/OPTIAlternateThree.otf",
    displayName: "OPTIAlternateThree",
  },
];
