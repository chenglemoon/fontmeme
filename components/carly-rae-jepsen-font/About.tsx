...
export default function About() {
  const t = useTranslations("CarlyRaeJepsenFont.about");
  const [fontLoaded, setFontLoaded] = useState(false);
  const titleCanvasRef = useRef<HTMLCanvasElement>(null);
  const [selectedFont] = useState("ColorsOfAutumn"); // 使用 Colors Of Autumn 字体
          ...
          <div className="space-y-6">
            <div className="relative">
              ...
              <p className="text-white text-base md:text-lg leading-relaxed pl-6">
                <em className="text-emerald-400">Emotion</em> {t("description1")}
              </p>
            </div>
